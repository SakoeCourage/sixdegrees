    ...
    return (
        <div className=' bg-primary-gray/60 '>
            <div className='container-content pt-10'>
                ...
                <section className=' grid grid-cols-3 py-16 gap-10'>
                    ...
                    <Inforcard className=' py-10' title='Client Connections'
                        icon={<svg xmlns="http://www.w3.org/2000/svg" className=' h-full w-full ' viewBox="0 0 48 48"><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M8 12a4 4 0 1 0 0-8a4 4 0 0 0 0 8Zm2 30a6 6 0 1 0 0-12a6 6 0 0 0 0 12Zm28 2a6 6 0 1 0 0-12a6 6 0 0 0 0 12ZM22 28a8 8 0 1 0 0-16a8 8 0 0 0 0 16Zm12-16a4 4 0 1 0 0-8a4 4 0 0 0 0 8Z" clip-rule="evenodd" /><path d="m11 11l4 4m15-3l-2 2m6 19.5L28 26m-14 5l4-4" /></g></svg>}
                    >
                        <p className=' w-full'>
